...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoginPage = __webpack_require__(232);
	
	var _LoginPage2 = _interopRequireDefault(_LoginPage);
	
	var _CreateAccountPage = __webpack_require__(234);
	...
	_react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(_reactRouter.Route, { path: '/create', component: _CreateAccountPage2.default })
		)
	);
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									_reactRouter.Link,
									{ to: '/create', activeClassName: 'active', activeStyle: { fontWeight: 'bold' } },
									'Create Account Here'
								)
							),
							_react2.default.createElement(
	...
	var Homepage = function (_Component) {
		...
		_createClass(Homepage, [{
			...
			value: function handleDeleteDream(id) {
				...
				var updateDreams = dreams.filter(function (dream) {
					return !dream.active;
				});
			...
			value: function componentWillMount() {
				...
				fetch('/home').then(function (response) {
					...
					var filtered = results.dreams.filter(function (dream) {
						return !dream.active;
					});
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_DreamList2.default, { dreams: updateDreams, handleDeleteDream: this.handleDeleteDream.bind(this) })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginPage = function (_Component) {
		...
		_createClass(LoginPage, [{
			key: 'handleNewData',
			value: function handleNewData(creds) {
				var loginUser = {
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_Login2.default, { onLogin: this.handleNewData.bind(this) })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Login = function (_Component) {
		...
		function Login() {
			...
			var _this = _possibleConstructorReturn(this, (_ref = Login.__proto__ || Object.getPrototypeOf(Login)).call.apply(_ref, [this].concat(args)));
		...
		_createClass(Login, [{
			key: 'onLoginSubmit',
			value: function onLoginSubmit(e) {
				e.preventDefault();
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							null,
							_react2.default.createElement('input', { type: 'text', ref: 'username', placeholder: 'Enter Username' })
						),
						_react2.default.createElement(
							'div',
							null,
							_react2.default.createElement('input', { type: 'password', ref: 'password', placeholder: 'Enter Password' })
						),
						_react2.default.createElement(
							'div',
							null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CreateAccount = __webpack_require__(235);
	...
	var CreateAccountPage = function (_Component) {
		...
		function CreateAccountPage() {
			...
			return _possibleConstructorReturn(this, (CreateAccountPage.__proto__ || Object.getPrototypeOf(CreateAccountPage)).apply(this, arguments));
		}
		...
		_createClass(CreateAccountPage, [{
			...
			value: function handleNewData(creds) {
				...
				fetch('/users/create', {
					...
					if (results.createdAt) {
						...
						results.errors.filter(function (result) {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_CreateAccount2.default, { onCreate: this.handleNewData.bind(this) })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CreateAccount = function (_Component) {
		...
		function CreateAccount() {
			...
			var _this = _possibleConstructorReturn(this, (_ref = CreateAccount.__proto__ || Object.getPrototypeOf(CreateAccount)).call.apply(_ref, [this].concat(args)));
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							null,
							_react2.default.createElement('input', { type: 'text', ref: 'firstname', placeholder: 'Enter First Name' })
						),
						_react2.default.createElement(
							'div',
							null,
							_react2.default.createElement('input', { type: 'text', ref: 'lastname', placeholder: 'Enter Last Name' })
						),
						_react2.default.createElement(
							'div',
							null,
						...
						_react2.default.createElement(
							'div',
							null,
							_react2.default.createElement('input', { type: 'text', ref: 'email', placeholder: 'Enter Email' })
						),
						_react2.default.createElement(
							'div',
							null,
